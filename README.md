...
- php artisan make:controller Api\\ClienteApiController --resource (Cria uma controller na pasta Api, se linux duas barras, resource cria os endpoints automaticamente)
